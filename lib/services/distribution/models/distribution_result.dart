...
class DistributionResult {
  ...
  bool get isSuccess => status == DistributionResultStatus.success;
  bool get isSkipped => status == DistributionResultStatus.skipped;
  bool get isFailed => status == DistributionResultStatus.failed;
}
