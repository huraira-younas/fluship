...
final class GitHubPreset implements ThemePresetModule {
  ...
  AppTheme get lightTheme => AppTheme(
    palette: ThemePalette(
      consoleBorder: colorFromHex('#d8dee4'),
      ...
      consoleBg: colorFromHex('#ffffff'),
      disabled: colorFromHex('#eaeef2'),
      textDim: colorFromHex('#57606a'),
      section: colorFromHex('#424a53'),
  ...
  AppTheme get darkTheme => AppTheme(
    palette: ThemePalette(
      ...
      consoleInner: colorFromHex('#010409'),
      ...
      disabled: colorFromHex('#21262d'),
      textDim: colorFromHex('#7d8590'),
      section: colorFromHex('#9198a1'),
